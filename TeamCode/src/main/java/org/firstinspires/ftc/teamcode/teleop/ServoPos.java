...
public class ServoPos extends OpMode {
    ...
    public static double ClawPos=0,LinkagePos=0,RotateClawPos=0,ClawTiltPos=0,SliderClawPos=0,SliderClawRotatePos=.84,SliderClawTiltPos=0,ModificaUnghiPos=0,RotateAssemplyPos=0;
