...
public class Teleop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if(gamepad1.b) {scoreAction.placeInHighBasket();sliderController.setTargetPosition(SliderAction.SliderPos());}
            ...
            if(gamepad1.right_stick_button){scoreAction.placeSample();sliderController.setTargetPosition(scoreAction.SliderPos());}
